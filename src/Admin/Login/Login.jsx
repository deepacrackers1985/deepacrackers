        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button 
              type="submit" 
              disabled={loading}
              className="flex w-full justify-center items-center gap-2 rounded-md px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-700 dark:hover:bg-blue-600 sm:text-sm/6 disabled:opacity-70 cursor-pointer"
