...
export default function Report() {
  ...
  const generatePDF = (item) => {
    ...
    try {
      const doc = new jsPDF();
      doc.text('DEEPA CRACKERS', doc.internal.pageSize.width / 2, 14, { align: 'center' });
      doc.setFontSize(9);
      doc.text('RS Road, Thiruthuraipoondi | 8072 897 834 | deepatraders1985@gmail.com', doc.internal.pageSize.width / 2, 22, { align: 'center' });
